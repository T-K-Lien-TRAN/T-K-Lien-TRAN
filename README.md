...
- Building **web and mobile applications with HTML, CSS, TypeScript, JavaScript, Vue.js, Node.js, NestJS, PHP, React, React Native, Flutter, Dart, Prisma, Swagger, Directus, MySQL, SQLite, PostgreSQL, as well as developing data science solutions with Python, R and AI**
- Interested in **web and mobile development, software architecture, data and database, AI and algorithms**
...
| [**Tokenizer**](https://github.com/T-K-Lien-TRAN/Tokenizer)| Blockchain project involving the development, testing, deployment, and interaction with a fixed-supply ERC-20/BEP-20-compatible token on a local blockchain and the BNB Smart Chain Testnet. | Solidity · Hardhat · TypeScript · OpenZeppelin · ERC-20 · BEP-20 · BNB Smart Chain |
